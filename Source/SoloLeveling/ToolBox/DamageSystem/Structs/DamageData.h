...
public:
	...
	// Default constructor
	FDamageData()
		: Amount(0), bHeadshot(false), DamageType(EDamageType::None), ResponseDamageType(EResponseDamageType::None), bForceAnimationInterrupt(false), bDoInvincibleDamage(false), bCanBeBlocked(false), bCanBeParried(false)
	{
	}
};